...
netflix_csv = pd.read_csv("C:\\Users\\Björn\\PythonVenv\\netflix_data\\netflix-report\\CONTENT_INTERACTION\\ViewingActivity.csv", usecols = ['Start Time']) 
...
plt.title("Probability of watching Netflix in a given hour")
